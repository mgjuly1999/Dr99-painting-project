 ...
 <%@ include file="/resources/admin/headerAndSlideBar/HeaderAndMainSlider.jsp" %>
  ...
  <section class="content">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Guide Register</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <div class="card card-success">
                ...
                <h3 class="card-title">Guide Register</h3>
              </div>
        <div class="card-body">
          <form:form action="guideLanguageRegisterSubmitPath" modelAttribute="guideLanguageRegisterForm.guideLanguageForm" method="POST" enctype="multipart/form-data" >
                <div class="card-body">
             <div class="row">
        	<div class="col-md-6">
                 ...
                 <form:input type="text" id="guideType" path="guideType" name="guideType"  class="form-control"  data-mask="data-mask" />
                  </div>
         		 </div>
         		   <div class="form-group">
				 Guide Value :
                 ...
                 <form:input type="text" id="guideValue" path="guideValue" name="guideValue"  class="form-control"  data-mask="data-mask" />
                  </div>
         		 </div>
                <div class="form-group">
	             <div class="input-group">
        ...
        <div class="col-15">
         ...
         <div class="card-body">
			...
			<th>Guide Value</th>
                ...
                <tbody>
                <c:forEach var="at" items="${guideLanguageRegisterForm.guideLanguages}" varStatus="s">
			<tr>
				<td>${s.index+1}</td>
			    <td>${at.guideType}</td>
			    <td>${at.guideValue}</td>
