...
<div class="wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Member Register</a></li>
        ...
        <div class="row">
          <div class="col-md-6">
             <div class="card card-success">
              ...
              <h3 class="card-title">Member Register</h3>
              </div>
              <!-- /.card-header -->
             <div class="card-body">
             <div class="row">
        	<div class="col-md-6">
        	 <form:form action="memberRegisterSubmit" modelAttribute="memberForm" method="POST" enctype="multipart/form-data" >
				...
				Member Email  :
                 ...
                 <form:input type="text" id="mail" path="mail" name="mail"  class="form-control"  data-mask="data-mask" />
                  </div>
         		 </div> 
 ...
 <!-- select -->
                      <div class="form-group">
                       ...
                       <form:select path="memberStatusId" name="memberStatusId" id="memberStatusId" class="form-control" > 
                       <form:options items="${memberRegisterForm.mapMemberStatus}"/>
                       </form:select>
                      </div>
