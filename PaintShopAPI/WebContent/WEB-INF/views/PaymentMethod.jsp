  ...
  <section class="content">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col">
            <h1>Make Payment method</h1>
           </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Admin Home</a></li>
              <li class="breadcrumb-item active">Make Payment method</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
     ...
     <!-- Main content -->
        <div class="card card-success">
                ...
                <h3 class="card-title">Make Payment method</h3>
              </div>
        <div class="card-body">
          <form:form action="verifyPhoneNumberSubmit" modelAttribute="verifyPhoneNumberForm" method="POST" enctype="multipart/form-data" >
              <div class="card-body">
                <div class="row">
        	    <div class="col-md-6">
        	      <div class="col-sm-6">
                 ...
                 <form:input type="text" id="InvoiceNo" path="InvoiceNo" name="InvoiceNo"  class="form-control"  data-mask="data-mask" />
                  </div>
         		 </div>
        	       <div class="form-group">
					Amount  :
                 ...
                 <form:input type="text" id="amount" path="amount" name="amount"  class="form-control"  data-mask="data-mask" />
                  </div>
         		 </div>
         		     <div class="form-group">
				 One Pay Phone Number :
                  <div class="input-group">
                    <div class="input-group-prepend">
                      <span class="input-group-text"><i class="far fa-calendar-alt"></i></span>
                    </div>
                 <form:input type="text" id="OnepayPhoneNo" path="OnepayPhoneNo" name="OnepayPhoneNo"  class="form-control"  data-mask="data-mask" />
                  </div>
         		 </div>
         		 <div class="form-group">
				<Label>${message}</Label>
