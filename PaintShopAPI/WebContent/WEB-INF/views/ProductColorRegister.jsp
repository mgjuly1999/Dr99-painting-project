...
<head>
  ...
  <title>Product Color Register</title>
  ...
  <section class="content">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col">
            <h1>Product Color Register</h1>
           </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Admin Home</a></li>
              <li class="breadcrumb-item active">Product Color Register</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
	 ...
	 <form:form action="productColorRegisterSubmit" modelAttribute="productColorForm" method="POST" enctype="multipart/form-data" >
          	
        <form:input type="text" id="productId" path="productId" 
        name="productId" value="${productColorRegisterForm.product.productId}"  hidden="hidden"/>
           
             <div class="col-15">
           <div class="card card-success">
                <div class="card-header">
                <h3 class="card-title">Select Product Color Group</h3>
              </div>
        <div class="card-body">
			...
			<th>Select</th>
                ...
                <tbody>
                <c:forEach var="colorGroup" items="${productColorRegisterForm.colorGroups}" varStatus="s">
			<tr>
				<td>${s.index+1}</td>
			    <td>${colorGroup.colorNumber}</td>
		   		<td>${colorGroup.colorName}</td>
			    <th>
			    <form:checkbox path="colorGroups" 
			    value="${colorGroup.colorGroupId}"/>
			    </th>
			</tr>		
		    </c:forEach>
