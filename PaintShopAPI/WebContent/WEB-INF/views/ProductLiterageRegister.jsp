...
<head>
  ...
  <title>Product Literage Register</title>
        ...
        <div class="row mb-10">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Product Literage Register</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-md-15">
             <div class="card card-success">
              ...
              <h3 class="card-title">Product Literage Register</h3>
              </div>
              <!-- /.card-header -->
             <div class="card-body">
             <div class="row">
        	<div class="col-md-15">
        	 ...
        	 <form:form action="productLiterageRegisterSubmit" modelAttribute="productLiterageForm" method="POST" enctype="multipart/form-data" >
   
       <form:input type="text" id="productId" path="productId" name="productId" 
       value="${productLiterageRegisterForm.product.productId}" hidden="hidden" />
                        
          	    <div class="form-group">
						Unit Price :
                  <div class="input-group">
                    
                 <form:input type="text" id="unitPrice" path="unitPrice" name="unitPrice"  class="form-control"  data-mask="data-mask" />
                  </div>
                 </div> 
         		  <div class="form-group">
				Product  Litreage :
                 ...
                 <form:input type="text" id="qty" path="qty" name="qty"  class="form-control"  data-mask="data-mask" />
                  <form:select path="qtyUnitId" name="qtyUnitId" id="qtyUnitId" class="form-control" > 
                       <form:options items="${productLiterageRegisterForm.mapQtyUnits}"/>
                  </form:select>
                  </div>
         		 </div>           		
         		  <div class="form-group">
          ...
          <form:form action="productLiterageRegisterFinishSubmit" modelAttribute="productLiterageForm" method="POST" enctype="multipart/form-data" >
