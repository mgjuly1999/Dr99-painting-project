...
<head>
  ...
  <title>Product Media Register</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Product Media Register</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-6">
             <div class="card card-success">
              ...
              <h3 class="card-title">Product Media Register</h3>
              </div>
              <!-- /.card-header -->
             <div class="card-body">
             <div class="row">
        	<div class="col-md-6">
        	 <form:form action="productMediaRegisterSubmit" modelAttribute="productMediaForm" method="POST" enctype="multipart/form-data" >

 			<form:input type="text" id="productId" path="productId" 
        name="productId" value="${productMediaRegisterForm.product.productId}"  hidden="hidden"/>
         

                      <div class="form-group">
                        <label>Select Folder</label>
                       <form:select path="folderId" name="folderId" id="folderId" class="form-control" > 
                       <form:options items="${productMediaRegisterForm.mapFolders}"/>
                       </form:select>
                      </div>
            ...
            <form:form action="productDetilsPath" modelAttribute="productMediaForm" method="POST" enctype="multipart/form-data" >
            	<form:input type="text" id="productId" path="productId" 
        name="productId" value="${productMediaRegisterForm.product.productId}"  hidden="hidden"/>
        ...
        <div class="card-body">
			...
			<th> Image </th>
                ...
                <tbody>
                <c:forEach var="productMedia" items="${productMediaRegisterForm.productMedias}" varStatus="s">
			<tr>
				<td>${s.index+1}</td>
			    <td>${productMedia.folder.name}</td>
			    <td>
			    
			    <img 
					width="100" height="100"
		src="productMediaImageUploadPath?id=${productMedia.productMediaId}&folderName=${productMedia.folder.name}&frmType=0&frmImage=1">
				</td>
			    <th> 
			    </th>
			</tr>		
