      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-10">
             ...
             <div class="row">
        	<div class="col-md-10">
        	 <form:form action="productRegisterSubmit" modelAttribute="productForm" method="POST" enctype="multipart/form-data" >
          	   
         <form:input type="text" id="groupId" path="groupId" name="groupId"  value="${productRegisterForm.groupId}" hidden="hidden"/>
				...
				ProductTitle :
                 ...
                 <form:input type="text" id="productTitle" path="productTitle" name="productTitle"  class="form-control"  data-mask="data-mask" />
                  </div>
         		 </div>         		
         		  
	       			<div class="form-group">
                        <label>Product Type</label>
                       <form:select path="productTypeId" name="productTypeId" id="productTypeId" class="form-control" > 
                       <form:options items="${productRegisterForm.mapProductTypes}"/>
                       </form:select>
                      </div>
                     
                    <div class="form-group">
                        <label>Product Quality </label>
                       <form:select path="qualityId" name="qualityId" id="qualityId" class="form-control" > 
                       <form:options items="${productRegisterForm.mapProductQuality}"/>
                       </form:select>
                      </div>
				...
				Total Qty :
                 ...
                 <form:input type="text" id="totalQty" path="totalQty" name="totalQty"  class="form-control"  data-mask="data-mask" />
                  <form:select path="qtyUnitId" name="qtyUnitId" id="qtyUnitId" class="form-control" > 
                       <form:options items="${productRegisterForm.mapQtyUnit}"/>
                       </form:select>
                  </div>
         		 </div> 
				...
				Description :
                 ...
                 <form:textarea type="text" id="description" path="description" name="description"  class="form-control"  data-mask="data-mask" />
                  </div>
         		 </div> 
