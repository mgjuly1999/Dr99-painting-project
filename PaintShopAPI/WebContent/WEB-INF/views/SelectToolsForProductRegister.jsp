  ...
  <section class="content">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col">
            <h1>Select Product Tools</h1>
           </div>
          <div class="col-md-30">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Admin Home</a></li>
              <li class="breadcrumb-item active">Select Product Tools</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
	 ...
	 <form:form action="SelectToolsForProductRegisterSubmit" modelAttribute="productNextForm" method="POST" enctype="multipart/form-data" >
