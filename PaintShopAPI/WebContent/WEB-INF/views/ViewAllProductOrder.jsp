        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">View All Order</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="row">
        ...
        <div class="col-10">
           <div class="card card-success">
                ...
                <h3 class="card-title">View All Order</h3>
              </div>
        <div class="card-body">
		...
		<th>View Details</th>
                ...
                <c:forEach var="orderForm" items="${viewAllOrderForm.orderHistory}" varStatus="s">
			<tr>
		
				<td>${s.index+1}</td>
				<td>${orderForm.orderFormId}</td>
				<td>${orderForm.phone}</td>
				<td>${orderForm.addressDetails}</td>
				<td>${orderForm.totalPrice}</td>
				<td>${orderForm.totalDicountRate}</td>
				<td>${orderForm.deliveryAddress}</td>
				<td>${orderForm.deliveryType}</td>
				<td>${orderForm.paymentDue}</td>
				
			    <th><a href="orderFormDetails?orderFormId=${orderForm.orderFormId}"
			     class="btn btn-block btn-outline-primary btn-sm">Details</a></th>
			</tr>		
		    </c:forEach>
