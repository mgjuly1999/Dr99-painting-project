...
<%@ include file="/resources/admin/headerAndSlideBar/HeaderAndMainSlider.jsp" %>
  ...
  <section class="content">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Color Group Register</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <div class="card card-success">
                ...
                <h3 class="card-title">Color Group Register</h3>
              </div>
        <div class="card-body">
          <form:form action="colorGroupRegisterSubmitPath" modelAttribute="colorGroupRegisterForm.colorGroupForm" method="POST" enctype="multipart/form-data" >
                <div class="card-body">
             <div class="row">
        	<div class="col-md-6">
      ...
      <div class="row">
        <div class="col-15">
           <div class="card card-success">
                <div class="card-header">
                <h3 class="card-title">Show All Color Group</h3>
              </div>
        <div class="card-body">
			...
			<th>Delete</th>
                ...
                <tbody>
                <c:forEach var="at" items="${colorGroupRegisterForm.colorGroups}" varStatus="s">
			<tr>
				<td>${s.index+1}</td>
				<td>${at.colorGroupId}</td>
			    <td>${at.colorName}</td>
				<td>${at.htmlColorCode}</td>
				<td>${at.colorNumber}</td>
