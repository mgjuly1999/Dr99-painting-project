        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Color Register</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-md-6">
             <div class="card card-success">
              ...
              <h3 class="card-title">Color Register</h3>
              </div>
              <!-- /.card-header -->
             <div class="card-body">
             <div class="row">
        	<div class="col-md-6">
        	 ...
        	 <form:form action="colorRegisterSubmitPath" modelAttribute="colorRegisterForm.colorForm" method="POST" enctype="multipart/form-data" >
          	     <div class="col-sm-6">
                      <!-- select -->
                      <div class="form-group">
                        <label>Select ColorGroup</label>
                       <form:select path="colorGroupId" name="colorGroupId" id="productGroupId" class="form-control" > 
                       <form:options items="${colorRegisterForm.mapColorGroups}"/>
                       </form:select>
                      </div>
                    </div> 
          	    <div class="form-group">
				Color Name :
                 ...
                 <form:input type="text" id="colorName" path="colorName" name="colorName"  class="form-control"  data-mask="data-mask" />
                  </div>
                 </div> 
         		  <div class="form-group">
				HtmlColor Code :
                 ...
                 <form:input type="text" id="htmlColorCode" path="htmlColorCode" name="htmlColorCode"  class="form-control"  data-mask="data-mask" />
                  </div>
         		 </div>           		
         		  <div class="form-group">
				ColorNumber :
                 ...
                 <form:input type="text" id="colorNumber" path="colorNumber" name="colorNumber"  class="form-control"  data-mask="data-mask" />
                  </div>
         		 </div>
              <div class="form-group">
	             <div class="input-group">
