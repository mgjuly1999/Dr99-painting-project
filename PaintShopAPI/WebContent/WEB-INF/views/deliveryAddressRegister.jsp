...
<%@ include file="/resources/admin/headerAndSlideBar/HeaderAndMainSlider.jsp" %>
  ...
  <section class="content">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Delivery Address Register</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <div class="card card-success">
                ...
                <h3 class="card-title">Delivery Address Register</h3>
              </div>
        <div class="card-body">
          <form:form action="deliveryAddressRegisterSubmitPath" modelAttribute="deliveryAddressRegisterForm.deliveryAddressForm" method="POST" enctype="multipart/form-data" >
                <div class="card-body">
             <div class="row">
        	<div class="col-md-6">
				...
				Delivery Price :
                 ...
                 <form:input type="text" id="deliveryPrice" path="deliveryPrice" name="deliveryPrice"  class="form-control"  data-mask="data-mask" />
                  </div>
         		 </div>
         		 <div class="form-group">
				Description :
      ...
      <div class="row">
        <div class="col-15">
           <div class="card card-success">
                <div class="card-header">
                <h3 class="card-title">Show All Delivery Address</h3>
              </div>
        <div class="card-body">
			...
			<th>Delete</th>
                ...
                <tbody>
                <c:forEach var="at" items="${deliveryAddressRegisterForm.deliveryAddresss}" varStatus="s">
			<tr>
				<td>${s.index+1}</td>
				<td>${at.deliveryAddressId}</td>
			    <td>${at.address}</td>
				<td>${at.deliveryPrice}</td>
