  ...
  <section class="content">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col">
            <h1>Delivery Type Register</h1>
           </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Admin Home</a></li>
              <li class="breadcrumb-item active">Delivery Type Register</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
     ...
     <!-- Main content -->
        <div class="card card-success">
                ...
                <h3 class="card-title">Delivery Type Register</h3>
              </div>
        <div class="card-body">
          <form:form action="deliveryTypeRegisterSubmitPath" modelAttribute="deliveryTypeRegisterForm.deliveryTypeForm" method="POST" enctype="multipart/form-data" >
              <div class="card-body">
                <div class="row">
        	    <div class="col-md-6">
        	      <div class="col-sm-6">
      ...
      <div class="row">
        <div class="col-15">
           <div class="card card-success">
                <div class="card-header">
                <h3 class="card-title">Show All Delivery Type</h3>
              </div>
        <div class="card-body">
			...
			<th>Name</th>
                ...
                <tbody>
                <c:forEach var="at" items="${deliveryTypeRegisterForm.deliveryTypes}" varStatus="s">
			<tr>
				<td>${s.index+1}</td>
				<td>${at.deliveryTypeId}</td>
			    <td>${at.name}</td>
