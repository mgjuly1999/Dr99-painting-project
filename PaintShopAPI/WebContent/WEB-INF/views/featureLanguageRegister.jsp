 ...
 <%@ include file="/resources/admin/headerAndSlideBar/HeaderAndMainSlider.jsp" %>
  ...
  <section class="content">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"> Feature Register</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <div class="card card-success">
                ...
                <h3 class="card-title">Feature Register</h3>
              </div>
        <div class="card-body">
          <form:form action="featureLanguageRegisterSubmitPath" modelAttribute="featureLanguageRegisterForm.featureLanguageForm" method="POST" enctype="multipart/form-data" >
                <div class="card-body">
             <div class="row">
        	<div class="col-md-6">
				...
				Feature Name :
                 ...
                 <form:input type="text" id="featureName" path="featureName" name="featureName"  class="form-control"  data-mask="data-mask" />
                  </div>
         		 </div>
                <div class="form-group">
	             <div class="input-group">
      ...
      <div class="row">
        <div class="col-15">
           <div class="card card-success">
                <div class="card-header">
                <h3 class="card-title">Show All Feature</h3>
              </div>
         <div class="card-body">
			...
			<th>Delete</th>
                ...
                <tbody>
                <c:forEach var="at" items="${featureLanguageRegisterForm.featureLanguages}" varStatus="s">
			<tr>
				<td>${s.index+1}</td>
			    <td>${at.featureName}</td>
