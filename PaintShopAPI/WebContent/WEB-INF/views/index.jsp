...
<html lang="en">
	...
	<head><base href="">
		...
		<link href="<c:url value="resources/assets/css/themes/layout/header/base/light.css"/>" rel="stylesheet" type="text/css" />
		<link href="<c:url value="resources/assets/css/themes/layout/header/menu/light.css"/>" rel="stylesheet" type="text/css" />
		<link href="<c:url value="resources/assets/css/themes/layout/brand/dark.css"/>" rel="stylesheet" type="text/css" />
		<link href="<c:url value="resources/assets/css/themes/layout/aside/dark.css"/>" rel="stylesheet" type="text/css" />
		<!--end::Layout Themes-->
