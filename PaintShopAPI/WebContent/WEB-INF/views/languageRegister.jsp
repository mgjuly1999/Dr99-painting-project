    ...
    <section class="content-header">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Language Register</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
     ...
     <!-- Main content -->
        <div class="card card-success">
                ...
                <h3 class="card-title">Language Register</h3>
              </div>
        <div class="card-body">
          <form:form action="languageRegisterSubmitPath" modelAttribute="languageRegisterForm.languageForm" method="POST" enctype="multipart/form-data" >
              <div class="card-body">
                <div class="row">
        	    <div class="col-md-6">
        	      <div class="col-sm-6">
				...
				Language Code :
                 ...
                 <form:input type="text" id="code" path="code" name="code"  class="form-control"  data-mask="data-mask" />
                  </div>
         		 </div>
                </div> 
               <div class="form-group">
      ...
      <div class="row">
        <div class="col-15">
           <div class="card card-success">
                <div class="card-header">
                <h3 class="card-title">Show All Language</h3>
              </div>
        <div class="card-body">
			...
			<th>Delete</th>
                ...
                <tbody>
                <c:forEach var="at" items="${languageRegisterForm.languages}" varStatus="s">
			<tr>
				<td>${s.index+1}</td>
				<td>${at.languageId}</td>
			    <td>${at.name}</td>
