...
<%@ include file="/resources/admin/headerAndSlideBar/HeaderAndMainSlider.jsp" %>
  ...
  <section class="content">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">OrderForm Register</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <div class="card card-success">
                ...
                <h3 class="card-title">OrderForm Register</h3>
              </div>
        <div class="card-body">
          <form:form action="orderFormRegisterSubmitPath" modelAttribute="orderFormRegisterForm.orderFormForm" method="POST" enctype="multipart/form-data" >
                <div class="card-body">
             <div class="row">
        	<div class="col-md-6">
                 ...
                 <form:input type="text" id="addressDetails" path="addressDetails" name="addressDetails"  class="form-control"  data-mask="data-mask" />
                  </div>
         		 </div>
         		  <div class="form-group">
				 TotalDicountRate :
                 ...
                 <form:input type="text" id="totalDicountRate" path="totalDicountRate" name="totalDicountRate"  class="form-control"  data-mask="data-mask" />
                  </div>
         		 </div>
         		  <div class="form-group">
				 TotalPrice :
                 ...
                 <form:input type="text" id="totalPrice" path="totalPrice" name="totalPrice"  class="form-control"  data-mask="data-mask" />
                  </div>
         		 </div>
                   <div class="col-sm-6">
                      <!-- select -->
                      <div class="form-group">
                       ...
                       <form:select path="deliveryTypeId" name="deliveryTypeId" id="deliveryTypeId" class="form-control" > 
                       <form:options items="${orderFormRegisterForm.mapDeliveryTypes}"/>
                       </form:select>
                      </div>
                    </div> 
                      <div class="col-sm-6">
                      ...
                      <div class="form-group">
                       ...
                       <form:select path="deliveryAddressId" name="deliveryAddressId" id="deliveryAddressId" class="form-control" > 
                       <form:options items="${orderFormRegisterForm.mapDeliveryAddresss}"/>
                       </form:select>
                      </div>
                    </div> 
                     <div class="col-sm-6">
                      <!-- select -->
                      <div class="form-group">
                        <label>Select PaymentMethod Address</label>
                       <form:select path="paymentMethodId" name="paymentMethodId" id="paymentMethodId" class="form-control" > 
                       <form:options items="${orderFormRegisterForm.mapPaymentMethods}"/>
                       </form:select>
                      </div>
                    </div> 
         	     <div class="form-group">
                 ...
                 <form:input type="text" id="note" path="note" name="note"  class="form-control"  data-mask="data-mask" />
                  </div>
         		 </div>
