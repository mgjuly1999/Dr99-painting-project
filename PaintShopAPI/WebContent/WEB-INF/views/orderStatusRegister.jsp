  ...
  <section class="content">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col">
            <h1>Order Status Register</h1>
           </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Admin Home</a></li>
              <li class="breadcrumb-item active">Order Status Register</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
     ...
     <!-- Main content -->
        <div class="card card-success">
                ...
                <h3 class="card-title">Order Status Register</h3>
              </div>
        <div class="card-body">
          <form:form action="orderStatusRegisterSubmitPath" modelAttribute="orderStatusRegisterForm.orderStatusForm" method="POST" enctype="multipart/form-data" >
              <div class="card-body">
                <div class="row">
        	    <div class="col-md-6">
        	      <div class="col-sm-6">
      ...
      <div class="row">
        <div class="col-15">
           <div class="card card-success">
                <div class="card-header">
                <h3 class="card-title">Show All Order Status</h3>
              </div>
        <div class="card-body">
			...
			<th>Delete</th>
                ...
                <tbody>
                <c:forEach var="at" items="${orderStatusRegisterForm.orderStatuss}" varStatus="s">
			<tr>
				<td>${s.index+1}</td>
				<td>${at.statusId}</td>
			    <td>${at.statusName}</td>
