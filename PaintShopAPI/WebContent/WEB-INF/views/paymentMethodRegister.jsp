        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Payment Method Register</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <!-- Main content -->
        ...
        <div class="row">
          <div class="col-md-6">
             <div class="card card-success">
              ...
              <h3 class="card-title">Payment Method Register</h3>
              </div>
              <!-- /.card-header -->
             <div class="card-body">
             <div class="row">
        	<div class="col-md-6">
        	 ...
        	 <form:form action="paymentMethodRegisterSubmitPath" modelAttribute="paymentMethodRegisterForm.paymentMethodForm" method="POST" enctype="multipart/form-data" >
				...
				Service Name :
                 ...
                 <form:input type="text" id="serviceName" path="serviceName" name="serviceName"  class="form-control"  data-mask="data-mask" />
                  </div>
                 </div> 
                   <div class="form-group">
				SerialId :
                 ...
                 <form:input type="text" id="serialId" path="serialId" name="serialId"  class="form-control"  data-mask="data-mask" />
                  </div>
         		 </div>
         		  <div class="form-group">
				Phone :
      ...
      <div class="row">
        <div class="col-15">
           <div class="card card-success">
                <div class="card-header">
                <h3 class="card-title">Show All Payment Method</h3>
              </div>
        <div class="card-body">
			...
			<th>Delete</th>
                ...
                <tbody>
                <c:forEach var="at" items="${paymentMethodRegisterForm.paymentMethods}" varStatus="s">
			<tr>
				<td>${s.index+1}</td>
				<td>${at.paymentMethodId}</td>
				<td>${at.serviceName}</td>
			    <td>${at.phone}</td>
