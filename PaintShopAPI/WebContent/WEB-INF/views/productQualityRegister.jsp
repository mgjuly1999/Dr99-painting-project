  ...
  <section class="content">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col">
            <h1>Product Quality Register</h1>
           </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Admin Home</a></li>
              <li class="breadcrumb-item active">Product Quality Register</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
     ...
     <!-- Main content -->
        <div class="card card-success">
                ...
                <h3 class="card-title">Product Quality Register</h3>
              </div>
        <div class="card-body">
          <form:form action="productQualityRegisterSubmit" modelAttribute="productQualityForm" method="POST" enctype="multipart/form-data" >
              <div class="card-body">
                <div class="row">
        	    <div class="col-md-6">
        	      <div class="col-sm-6">
      ...
      <div class="row">
        <div class="col-15">
           <div class="card card-success">
                <div class="card-header">
                <h3 class="card-title">Show All Product Quality</h3>
              </div>
        <div class="card-body">
			...
			<th>Delete</th>
                ...
                <tbody>
                <c:forEach var="at" items="${productQualityRegisterForm.productQualitys}" varStatus="s">
			<tr>
				<td>${s.index+1}</td>
				<td>${at.productQualityId}</td>
			    <td>${at.name}</td>
