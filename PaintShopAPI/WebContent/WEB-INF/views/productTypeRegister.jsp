        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Product Type Register</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <!-- Main content -->
        ...
        <div class="row">
          <div class="col-md-6">
             <div class="card card-success">
              ...
              <h3 class="card-title">Product Type Register</h3>
              </div>
              <!-- /.card-header -->
             <div class="card-body">
             <div class="row">
        	<div class="col-md-6">
        	 ...
        	 <form:form action="productTypeRegisterSubmitPath" modelAttribute="productTypeRegisterForm.productTypeForm" method="POST" enctype="multipart/form-data" >
          	     
                      <!-- select -->
                      <div class="form-group">
                        <label>Select Group</label>
                       <form:select path="productGroupId" name="productGroupId" id="productGroupId" class="form-control" > 
                       <form:options items="${productTypeRegisterForm.mapProductGroups}"/>
                       </form:select>
                      </div>
      ...
      <div class="row">
        <div class="col-15">
           <div class="card card-success">
                <div class="card-header">
                <h3 class="card-title">Show All Product Type</h3>
              </div>
        <div class="card-body">
			...
			<th>Delete</th>
                ...
                <tbody>
                <c:forEach var="at" items="${productTypeRegisterForm.typeLanguages}" varStatus="s">
			<tr>
				<td>${s.index+1}</td>
				<td>${at.name}</td>
				<c:set var = "string2" value = "${fn:substring(at.description,0, 15)}" />
			    <td>${string2}</td>
