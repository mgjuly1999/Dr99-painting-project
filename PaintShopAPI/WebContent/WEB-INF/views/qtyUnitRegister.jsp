...
<%@ include file="/resources/admin/headerAndSlideBar/HeaderAndMainSlider.jsp" %>
  ...
  <section class="content">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Quantity Unit Register</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <div class="card card-success">
                ...
                <h3 class="card-title">Quantity Unit Register</h3>
              </div>
        <div class="card-body">
          <form:form action="qtyUnitRegisterSubmitPath" modelAttribute="qtyUnitRegisterForm.qtyUnitForm" method="POST" enctype="multipart/form-data" >
                <div class="card-body">
             <div class="row">
        	<div class="col-md-6">
				...
				Unit Name :
                 ...
                 <form:input type="text" id="unit" path="unit" name="unit"  class="form-control"  data-mask="data-mask" />
                  </div>
         		 </div>
         		    <div class="form-group">
				Description :
      ...
      <div class="row">
        <div class="col-15">
           <div class="card card-success">
                <div class="card-header">
                <h3 class="card-title">Show All Quantity Unit</h3>
              </div>
         <div class="card-body">
			...
			<th>Delete</th>
                ...
                <tbody>
                <c:forEach var="at" items="${qtyUnitRegisterForm.qtyUnits}" varStatus="s">
			<tr>
				<td>${s.index+1}</td>
				<td>${at.qtyUnitId}</td>
			    <td>${at.unit}</td>
