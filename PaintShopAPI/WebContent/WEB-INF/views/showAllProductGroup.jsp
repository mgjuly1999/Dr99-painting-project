      ...
      <div class="row">
        ...
        <div class="col-10">
           <div class="card card-success">
                ...
                <h3 class="card-title">Show All Product Group</h3>
              </div>
        <div class="card-body">
			...
			<th>Delete</th>
                ...
                <tbody>
                <c:forEach var="at" items="${productGroupRegisterForm.groupLanguages}" varStatus="s">
			<tr>
				<td>${s.index+1}</td>
				<td>${at.productGroup.productGroupId}</td>
			    <td>${at.name}</td>
			    <th><a href="productRegisterPath?groupId=${at.productGroup.productGroupId}" class="btn btn-block btn-outline-primary btn-sm">Add Product</a></th>
