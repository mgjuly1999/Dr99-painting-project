  ...
  <section class="content">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col">
            <h1>Show All Product Type</h1>
           </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Admin Home</a></li>
              <li class="breadcrumb-item active">Show All Product Type</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="row">
        ...
        <div class="card-body">
			...
			<th>View Products</th>
                ...
                <tbody>
                <c:forEach var="typeLanguage" items="${showAllTypeForm.typeLanguages}" varStatus="s">
			<tr>
				<td>${s.index+1}</td>
				<td>${typeLanguage.productType.productTypeId}</td>
			    <td>${typeLanguage.name}</td>
			    <th><a href="showAllProductForProductDetails?typeId=${typeLanguage.productType.productTypeId}" 
			    class="btn btn-block btn-outline-primary btn-sm">View Products</a></th>
