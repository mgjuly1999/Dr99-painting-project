...
<%@ include file="/resources/admin/headerAndSlideBar/HeaderAndMainSlider.jsp" %>
  ...
  <section class="content">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Tool Register</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <div class="card card-success">
                ...
                <h3 class="card-title">Tool Register</h3>
              </div>
        <div class="card-body">
          <form:form action="toolLanguageRegisterSubmitPath" modelAttribute="toolLanguageRegisterForm.toolLanguageForm" method="POST" enctype="multipart/form-data" >
                <div class="card-body">
             <div class="row">
        	<div class="col-md-6">
				...
				Tool Name :
                 ...
                 <form:input type="text" id="toolName" path="toolName" name="toolName"  class="form-control"  data-mask="data-mask" />
                  </div>
         		 </div>
         		 <div class="form-group">
				 Tool Picture :
				...
				Description :
                 ...
                 <form:textarea type="text" id="toolDescription" path="toolDescription" name="toolDescription"  
                 class="form-control"  data-mask="data-mask" />
                  </div>
         		 </div> 
      ...
      <div class="row">
        <div class="col-15">
           <div class="card card-success">
                <div class="card-header">
                <h3 class="card-title">Show All Tool</h3>
              </div>
         <div class="card-body">
			...
			<th>Delete</th>
                ...
                <tbody>
                <c:forEach var="at" items="${toolLanguageRegisterForm.toolLanguages}" varStatus="s">
			<tr>
				<td>${s.index+1}</td>
			    <td>${at.toolName}</td>
