...
public class GroupImageUploadController {

	@RequestMapping("/groupImageUploadPath")
	...
	{   
		...
		String frmImage=req.getParameter("frmImage");
		
		String serverPath=FileUpload.getImageUrl(id+"","ProductGroup");
