...
public class ProductMediaImageUploadController{

	@RequestMapping("/productMediaImageUploadPath")
	...
	{   
		...
		String serverPath=FileUpload.getImageUrl(id+"",folderName);
        ...
        { try
        {
        	...
        	serverPath=FileUpload.getImageUrl("default",folderName);
