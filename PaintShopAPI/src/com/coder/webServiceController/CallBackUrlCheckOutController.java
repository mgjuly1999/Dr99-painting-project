...
public class CallBackUrlCheckOutController {
	@Autowired
	private CheckOutService checkOutService;
	
	
	@PostMapping(
	        value = RestURIConstants.Call_Back_Url_Check_Out,
	...
	(@RequestBody Object object) throws JSONException {
		...
		this.checkOutService.prepareRespDirectPaymentAPICheckOut(respDirectPaymentAPIPrepareForm);
